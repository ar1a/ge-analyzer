...
ActiveRecord::Schema.define(version: 20_171_016_151_332) do
  create_table 'ahoy_events', force: :cascade do |t|
    ...
    t.index %w[user_id name], name: 'index_ahoy_events_on_user_id_and_name'
    t.index %w[visit_id name], name: 'index_ahoy_events_on_visit_id_and_name'
  end
